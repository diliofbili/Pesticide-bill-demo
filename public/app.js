...
function init() {
    ...
    window.isProcessingQuantityChange = false;
    ...
    // Expose the getPesticideData function globally
    window.getPesticideData = getPesticideData;
}

// Function to get the latest pesticide data
function getPesticideData() {
    // Return the current pesticide data
...
function increaseQuantity(index) {
    // Simple debounce to prevent rapid clicks from causing issues
    if (window.isProcessingQuantityChange) return;
    window.isProcessingQuantityChange = true;
